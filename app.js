...
let multiP=  multArr[0] * multArr[1] * multArr[2] ;
return[multiP, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${multiP}.`]
}
...
let newM = dynamicArray[0]*dynamicArray[1]*dynamicArray[2]*dynamicArray[3]*dynamicArray[4];

return [newM,`The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${newM}.`]
}
