...
Write a function called sum() that takes in two
numbers as arguments and then returns an array where the first element is the sum of those numbers,
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
        ...
        for (let i = 0; i < dynamicArray.length; i++) {
            gg = multiply(gg, dynamicArray[i])[0];
        }
        return [gg, `The numbers 1,2,3,4,5 have a product of 120.`]
    }
    // Here is the test for multiplyArray(); uncomment it to run it
