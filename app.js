...
function sumAndMultiply(a, b, c) { 
    ...
    return[f2 ,m2, `${a} and ${b} and ${c} sum to ${f2}.`,`The product of ${a} and ${b} and ${c} is ${m2}.`]
...
function multiplyArray(multArr) { //eslint-disable-line
    let multiofarray = multiply(multArr[0],multiply(multArr[1],multArr[2])[0]) [0];
    return[multiofarray,`The numbers 2,3,4 have a product of 24.`]
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for(let i =0 ; i < dynamicArray.length ; i++){
        ss=multiply(ss, dynamicArray[i])[0];
    }
return [ss,`The numbers 1,2,3,4,5 have a product of 120.`]
}
